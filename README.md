...
Справочник растений для Android, написанный на Kotlin с использованием Jetpack Compose. Приложение предоставляет подробную информацию о различных растениях, включая овощи, травы и комнатные растения.

<img width="270" height="600" alt="изображение" src="https://github.com/user-attachments/assets/430032db-af7e-46a1-9daf-aecd6cfc4080" />
